...
import 'package:retrowalk/ad_ump_status.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  Widget _buildNote(AppLocalizations l) {
    final String note1 = (Platform.isIOS) ? l.iosNote1 : l.androidNote1;
    final String note2 = (Platform.isIOS) ? l.iosNote2 : l.androidNote2;
    final String note3 = (Platform.isIOS) ? l.iosNote3 : l.androidNote3;
    final String note4 = (Platform.isIOS) ? l.iosNote4 : l.androidNote4;
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(note1, style: bodySmall),
              const SizedBox(height: 16),
              Text(note2, style: bodySmall),
              const SizedBox(height: 16),
              Text(note3, style: bodySmall),
              const SizedBox(height: 16),
              Text(note4, style: bodySmall),
            ],
          ),
        ),
      )
  ...
  Widget _buildAppDataShow(AppLocalizations l) {
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(l.openAppSetting, style: t.bodyLarge),
                  ]
                )
              )
            ),
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(l.usage1, style: bodySmall),
              const SizedBox(height: 16),
              Text(l.usage2, style: bodySmall),
              const SizedBox(height: 16),
              Text(l.usage3, style: bodySmall),
              const SizedBox(height: 16),
              Text(l.usage4, style: bodySmall),
            ],
          ),
        ),
      )
